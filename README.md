Alibaba Cloud Function Compute v3 (FCv3) Terraform Module

# terraform-alicloud-fcv3

English | [简体中文](https://github.com/alibabacloud-automation/terraform-alicloud-fcv3/blob/main/README-CN.md)

Terraform module which creates Function Compute (FCv3) resources on Alibaba Cloud. This module provides an equivalent solution enabling you to deploy serverless functions with comprehensive trigger support. [Efficient orchestration and management of serverless applications](https://www.aliyun.com/product/fc).

## Usage

Create a Function Compute function with HTTP trigger support:
...
* [Basic Example](https://github.com/alibabacloud-automation/terraform-alicloud-fcv3/tree/main/examples/basic)
* [Advanced Example](https://github.com/alibabacloud-automation/terraform-alicloud-fcv3/tree/main/examples/advanced)
